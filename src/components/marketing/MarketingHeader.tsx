    ...
    <header className="sticky top-0 z-50 border-b border-[#e5e7eb] bg-white/90 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="hidden items-center gap-4 md:flex">
          ...
          <Link
            to="/cadastro"
            className="rounded-full bg-[#00b7a8] px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#009b8e]"
          >
            Criar loja grátis
          </Link>
        </div>
        ...
        <div className="border-t border-[#e5e7eb] bg-white px-6 py-4 md:hidden">
          <div className="flex flex-col gap-4">
            ...
            <Link
              ...
              className="rounded-full bg-[#00b7a8] px-5 py-2.5 text-center text-sm font-semibold text-white"
            >
              Criar loja grátis
            </Link>
          </div>
